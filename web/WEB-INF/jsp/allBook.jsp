        ...
        <div class="row clearfix">
            ...
            <div class="row clearfix">
                <div class="col-md-4 column">
                    ...
                    <a class="btn btn-primary" href="${pageContext.request.contextPath}/book/toAllBook">显示全部书籍</a>
                </div>
                <div class="col-md-4 column">
                    <form action="${pageContext.request.contextPath}/book/queryBook" method="post" class="form-inline" style="float: right">
                        <span style="color: red;font-weight: bold">${error}</span>
                        <input type="text" name="queryBookName" class="form-control"  placeholder="请输入要查询的书籍名字" required>
